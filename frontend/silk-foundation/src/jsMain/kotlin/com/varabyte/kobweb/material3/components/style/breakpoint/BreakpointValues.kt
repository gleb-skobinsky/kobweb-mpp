...
package com.varabyte.kobweb.material3.components.style.breakpoint

import com.varabyte.kobweb.material3.style.breakpoint.BreakpointUnitValue
...
typealias BreakpointValues<T> = com.varabyte.kobweb.material3.style.breakpoint.BreakpointValues<T>
...
fun BreakpointSizes(
    ...
    lg: CSSpxValue,
    xl: CSSpxValue,
) = com.varabyte.kobweb.material3.style.breakpoint.BreakpointSizes(sm, md, lg, xl)
